...
window.addEventListener('scroll', function () {
    ...
    const typed =  new Typed('.multiple-text', { strings: ['Fullstack Developer', 'YouTuber', 'Blogger', 'Pianist and guitarist'], typeSpeed: 100, backSpeed: 100, backDelay: 1000, loop: true })